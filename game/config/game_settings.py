...
SKELETON1_SPRITESHEET = 'assets/images/skeletons/skeleton1.png'
SKELETON1_SPEED = 100
SKELETON1_SCALE = 1.5
...
SKELETON2_SPRITESHEET = 'assets/images/skeletons/skeleton2.png'
SKELETON2_SPEED = 90
SKELETON2_SCALE = 1.6
...
SKULL_SPRITESHEET = 'assets/images/skeletons/skull.png'
SKULL_SPEED = 160
SKULL_SCALE = 1.2
SKULL_HEALTH = 80
...
FLAME_SKULL_SPRITESHEET = 'assets/images/fire_skull/fire_skull.png'
FLAME_PROJECTLE_PATH = 'assets/images/fire_skull/fireball.png'
...
BLUE_SKULL_SPRITESHEET = 'assets/images/blue_skull/blue_skull.png'
BLUE_PROJECTLE_PATH = 'assets/images/blue_skull/blueball.png'
BLUE_SKULL_SPEED = 1
...
RESUME_BUTTON = 'assets/images/buttons/Resume/Resume'
RESTART_BUTTON = 'assets/images/buttons/Restart/Restart'
EXIT_BUTTON = 'assets/images/buttons/Quit/Quit'
START_BUTTON = 'assets/images/buttons/Start/Start'

LEVEL_1_TMX_PATH = "assets/levels/level1/Tileset_lvl_1.tmx"
LEVEL_2_TMX_PATH = "assets/levels/level2/Tileset_lvl_2.tmx"
LEVEL_3_TMX_PATH = "assets/levels/level3/Tileset_lvl_3.tmx"
LEVEL_4_TMX_PATH = "assets/levels/level4/Tileset_lvl_4.tmx"
LEVEL_5_TMX_PATH = "assets/levels/level5/Tileset_lvl_5.tmx"
LEVEL_6_TMX_PATH = "assets/levels/level6/Tileset_lvl_6.tmx"
LEVEL_BOSS_TMX_PATH = "assets/levels/boss/Tileset_boss.tmx"
...
MENU_BACKGROUND_IMAGE = 'assets/images/main_bg.png'
DEATH_TEXT_IMAGE = 'assets/images/death_text.png'
DEATH_BACKGROUND_IMAGE = 'assets/images/death_screen.png'
DEATH_IMAGE_WIDTH = 4120
DEATH_IMAGE_HEIGHT = 1000
IMAGE_SCALE = 0.2
BUTTON_SCALE = 8
BG_IMAGE_PATH = 'assets/images/main_bg.png'
BUTTON_SCALE = 8

MARGIN = 20
NUM_ENEMIES = 15

HEALTHDROP_IMAGE_PATH = 'assets/images/healthdrop/flasks_1'
...
HEALTHBAR_IMAGE_PATH = 'assets/images/health/healthFill.png'
CONTOUR_IMAGE_PATH = 'assets/images/health/healthContour.png'

ABILITY_IMAGE_PATH = 'assets/images/health/abilityFill.png'
ABILITY_CONTOUR_IMAGE_PATH = 'assets/images/health/abilityContour.png'

HEALTHBAR_SCALE_FACTOR = 5

VORTEX_PATH = 'assets/images/vortex/frame'
VORTEX_SCALE = 3.5
SPECIAL_ENEMIES_KILLED = 5

MUSIC_PATH = 'assets/sounds/music.wav'
SFX_DICT = {
    'slash': 'assets/sounds/SFX/slash.wav',
    'chop': 'assets/sounds/SFX/chop.wav',
    'roll': 'assets/sounds/SFX/roll.wav',
    'sprint': 'assets/sounds/SFX/sprint.wav',
    'enemy_attack': 'assets/sounds/SFX/enemy_attack.wav',
    'enemy_hit': 'assets/sounds/SFX/enemy_hit.wav',
    'lvl_end': 'assets/sounds/SFX/lvl_end.wav',
    'human_damage': 'assets/sounds/SFX/human_damage.wav',
    'healthdrop': 'assets/sounds/SFX/health.wav',
    'player_die': 'assets/sounds/SFX/player_die.wav',
    'vortex': 'assets/sounds/SFX/vortex.wav',
}

VORTEX_DAMAGE = 50
VORTEX_RADIUS = 150

MOMO_MAMA_SPRITESHEET = 'assets/images/momo_mama/momo_mama.png'
MOMO_MAMA_SPEED = 100
MOMO_MAMA_SCALE = 1.5
...
MOMO_MAMA_WANDER_TIME = 0
MOMO_JUMP_COOLDOWN = 3000
MOMO_RANGED_COOLDOWN = 10000
MOMO_SPAWN_COOLDOWN = 15000
MOMO_MELEE_COOLDOWN = 1000
MOMO_NUM_PROJECTILES = 10
MOMO_PROJECTILE_PATH = 'assets/images/momo_mama/momo_ball.png'

MOMO_HEALTH_CONTOUR = 'assets/images/health/momo_health_contour.png'
MOMO_HEALTH_FILL = 'assets/images/health/momo_health.png'
...
VICTORY_SCREEN = 'assets/images/victory_screen.png'
